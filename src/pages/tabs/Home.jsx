        ...
        return(
            <div className='wrap-home'>
                ...
                <div className='content-instruction'>
                    <p>
                        Выберите вкладку <NavLink to="/m/play">Игровое поле</NavLink>, чтобы начать игру. 
                        Здесь вы можете сыграть в крестики-нолики офлайн, просто кликнув на свободной ячейке.
                    </p>
                    <p>
                        Перейдите в раздел <NavLink to="/m/active-player">Активные игроки</NavLink>, чтобы пригласить кого-то в свое лобби. 
